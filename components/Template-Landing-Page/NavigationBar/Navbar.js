        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="#" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:block">
              <div className="font-bold text-lg bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">rexivo.id</div>
          ...
          >
            <div className="px-6 py-4 flex flex-col gap-3">
              ...
              <div className="flex gap-2 mt-3 pt-3 border-t border-slate-200">
                <button className="px-4 py-2 rounded-lg border border-slate-300 text-slate-600 font-medium bg-white">Login</button>
                <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-sky-500 to-blue-600 text-white font-medium">Get Started</button>
              </div>
            </div>
          </motion.div>
        )}
